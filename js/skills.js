...
export const ICONS = {
    ...
    vampire: '<svg viewBox="0 0 24 24" fill="currentColor"><g transform="translate(12, 12) scale(0.8) translate(-12, -12)"><path d="M12 2L9 12L12 17L15 12L12 2M7 7L2 12L7 17L7 7M17 7L17 17L22 12L17 7M12 17L9 22L12 24L15 22L12 17Z"/></g></svg>',
    ...
    berserk: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M8 13.5C6.5 13.5 6 12 6 10.5C6 9 7 7.5 8 7C9 7.5 10 9 10 10.5C10 12 9.5 13.5 8 13.5Z"/><path d="M12 17.5C10.5 17.5 10 16 10 14.5C10 13 11 11.5 12 11C13 11.5 14 13 14 14.5C14 16 13.5 17.5 12 17.5Z"/><path d="M16 13.5C14.5 13.5 14 12 14 10.5C14 9 15 7.5 16 7C17 7.5 18 9 18 10.5C18 12 17.5 13.5 16 13.5Z"/></svg>',
...
export const SKILLS = [
    ...
    },
    {
        ...
        apply: (player) => {
            player.vampire += 1;
            player.skills.vampire = (player.skills.vampire || 0) + 1;
        }
    },
    {
        id: 'freeze',
    ...
    },
    {
        ...
        apply: (player) => {
            ...
            // Level 2: +100% damage at ≤15% HP
            // Level 3: +150% damage at ≤20% HP
            player.berserkBonus = (player.berserkBonus || 0) + 0.5;
            player.skills.berserk = (player.skills.berserk || 0) + 1;
        }
    },
    {
        id: 'armor',
